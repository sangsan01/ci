...
<script type="text/javascript">
  ...
  $('#save').click(function(){  
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url();?>"+"index.php/Experience/insert",
      data: {start:start,end:end,detail:detail},
  ...
  function updatedata(str){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url();?>"+"index.php/Experience/update",
      data: {id:id,start:start,end:end,detail:detail},
      success:function(data) {
        $('#result').html(data);
  ...
  function deletedata(str){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url();?>"+"index.php/Experience/delete",
      data: {id:id},
      success:function(data) {
        $('#result').html(data);
        $("html,body").css("overflow","auto");
